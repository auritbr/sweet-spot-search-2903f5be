...
function NewsDetail() {
  ...
  return (
    <>
      <section className="relative isolate flex min-h-[430px] items-end overflow-hidden md:min-h-0 md:h-[410px] lg:h-[440px]">
        ...
        <div className="container-x w-full pb-16 pt-24 md:pb-7 md:pt-24">
          ...
          <h1 className="mt-4 max-w-4xl text-[clamp(1.75rem,7.2vw,2rem)] font-bold leading-[1.12] text-primary-foreground [overflow-wrap:break-word] [text-shadow:0_4px_22px_rgb(0_0_0_/_0.35)] md:text-[36px] md:leading-[1.08] lg:text-[44px]">{n.title}</h1>
          <p className="mt-4 max-w-3xl text-[15px] leading-[1.55] text-primary-foreground/90 md:mt-3 md:text-[15px] lg:text-[17px]">{n.excerpt}</p>
        </div>
      </section>
